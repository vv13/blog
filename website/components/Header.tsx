...
const HeaderComp: React.FC = () => {
  ...
  const isActive = router.pathname.startsWith('/blog');
  ...
  return (
    <header className={headerClasses}>
      <div className="max-w-screen-xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link
          className="text-xl font-bold tracking-tight no-underline transition-opacity hover:opacity-70 text-gray-900 dark:text-white"
          href="/"
        >
          vv13
        </Link>
        ...
        <nav className="flex items-center space-x-6">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center space-x-1.5 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-200"
          >
